package com.longtailvideo.jwplayer.controller {
	...
	import com.longtailvideo.jwplayer.request.HTTPRequest;
...
//				playlistLoadHandler();
				...
				///////////////////////////////////////////////////////////
				///////////////////////////////////////////////////////////
				var httpRequest:HTTPRequest = new HTTPRequest(_player);
				//如果是教学活动安排
				if(_player.config.teachingactivitydetailsid != 0)
				{
//					httpRequest.getLastViewLocationInfo();
					httpRequest.teachingScanNumberHandler();
//					httpRequest.teachingTimerHandler();
					httpRequest.startTimer(httpRequest.teachingTimerHandler);
				}
				if(_player.config.resourceinfoid != 0)
				{
					httpRequest.resoueceTimerHanlder();
					httpRequest.startTimer(httpRequest.resoueceTimerHanlder);
				}
				///////////////////////////////////////////////////////////
			}
		}
...
//				if(isSound){
//					//					Alert.show(1+";" + serverUrl);
//					//					serverUrl = getServiceUrl();
//					serverUrl = getServiceUrl() + "/updateResActComProAction.action?teachingActivityDetailsId="+teachingActivityDetailsId+"&lastViewLocation="+playTime;
//					saveTime.url = serverUrl;
//					saveTime.send();
//				}
			}
		};
