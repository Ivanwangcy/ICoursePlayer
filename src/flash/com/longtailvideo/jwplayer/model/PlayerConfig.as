package com.longtailvideo.jwplayer.model {
	...
	public dynamic class PlayerConfig extends EventDispatcher {
		...
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		protected var _teachingactivitydetailsid:Number = 0;
		protected var _hosturl:String = "htttp://127.0.0.1/";
		protected var _resourceinfoid:Number = 0;
...
//				trace("item: "+ item +"  value: " + config[item]);
				if (item.indexOf(".") > 0) {
...
//				trace("name:" + value);
		 ...
		 * 自定义属性 start
		 * */
		public function get teachingactivitydetailsid():Number
		{
			return _teachingactivitydetailsid;
		}
		
		/**
		 * @private
		 */
		public function set teachingactivitydetailsid(value:Number):void
		{
			_teachingactivitydetailsid = value;
		}
		public function get resourceinfoid():Number
		{
			return _resourceinfoid;
		}
		
		public function set resourceinfoid(value:Number):void
		{
			_resourceinfoid = value;
		}
